...
class DictionaryListFragment : Fragment(), DictionaryAdapter.ItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val dictionaryAdapter = DictionaryAdapter(requireActivity(), ArrayList(), this)
        dialogBuilder = AlertDialog.Builder(requireActivity(), R.style.ThemeOverlay_MaterialComponents_Dialog_Alert)
        setDefaultDatabase()
        createDialog = dialogBuilder.create()
    ...
    private fun openCreateDialog() {
        ...
        createButton.setOnClickListener {
            createDictionary(editText.text.toString(), createDialog, errorMessage)
        }
        cancelButton.setOnClickListener {
            errorMessage.show(false)
            createDialog.dismiss()
        }
        createDialog.setTitle(R.string.create_new_dictionary_dialog_title)
        createDialog.show()
    }
